...
class PublicacionController extends BaseController
{
  public function insertPublicacionAction()
  {
    ...
    try {
      ...
      if (
        !isset($inputData['correo']) || !isset($inputData['titulo']) ||
      ...
      $result = $publicacionModel->insertPublicacion(
        $correo,
        $titulo,
        $nombre_tema,
        $foto_portada,
  ...
  public function modifyAction()
  {
    ...
    try {
      ...
      if (
        !isset($inputData['id_publicacion']) || !isset($inputData['correo']) || !isset($inputData['titulo']) ||
        !isset($inputData['nombre_tema']) || !isset($inputData['foto_portada']) ||
